...
export const MOCK_USERS: User[] = [
  { id: 1, name: 'Ravi Kumar',      email: 'vendor@demo.com',   password: '123456', role: 'vendor',   company: 'RK Electricals Pvt Ltd', phone: '+91 98765 43210', department: '-' },
  { id: 2, name: 'Priya Sharma',    email: 'employee@demo.com', password: '123456', role: 'employee', company: 'Hinduja Renewables',     phone: '+91 91234 56789', department: 'Procurement' },
  { id: 3, name: 'Arun Mehta',      email: 'admin@demo.com',    password: '123456', role: 'admin',    company: 'Hinduja Renewables',     phone: '+91 99887 76655', department: 'IT' },
  { id: 4, name: 'Suresh Nair',     email: 'sap@demo.com',      password: '123456', role: 'sap',      company: 'Hinduja Renewables',     phone: '+91 88776 65544', department: 'Finance' },
]
...
export const MOCK_APPROVERS: Approver[] = [
  { level: 1, name: 'Deepak Joshi',     role: 'Senior Executive',    department: 'Procurement',        email: 'deepak.joshi@hindujarenewables.com' },
  { level: 2, name: 'Meera Pillai',     role: 'Finance Manager',     department: 'Finance & Payables', email: 'meera.pillai@hindujarenewables.com' },
  { level: 3, name: 'Vikram Choudhary', role: 'Finance Controller',  department: 'Finance',            email: 'vikram.c@hindujarenewables.com' },
]
